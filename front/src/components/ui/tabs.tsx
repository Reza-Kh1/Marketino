...
const TabsTrigger = ({
  ...
  const classTabs = classCustom ? "pb-3! group relative! text-sm! flex! items-center! gap-2! rounded-none! border-b-2! border-transparent! data-[state=active]:border-cyan-500! data-[state=active]:text-cyan-600! dark:data-[state=active]:text-cyan-400! data-[state=active]:bg-transparent! text-slate-500! hover:text-slate-800! dark:hover:text-slate-300! transition-all shadow-none!" : null
  const newClass = cn(
    classTabs ||
