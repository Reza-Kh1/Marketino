...
export default function UploadNotic() {
    ...
    return (
        <>
            <button onClick={() => setOpen(!open)} className="text-xs text-white-p-dark mb-2 hover:text-blue transition-all cursor-pointer">پیش از بارگذاری هرگونه رسانه، قوانین و ضوابط ارسال فایل را مطالعه فرمایید.</button>
