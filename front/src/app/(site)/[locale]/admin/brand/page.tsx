...
export default function page() {
    ...
    const columns: ColumnDef<BrandType>[] = useMemo(() => [
        ...
        },
        {
            ...
            id: 'name',
            header: 'نام',
            cell: ({ row }) => <span className="text-xs text-admin-text-muted font-mono">{row.original.name || ''}</span>
        },
        {
            accessorKey: 'nameEn',
            id: 'nameEn',
            header: 'نام (انگلیسی)',
            cell: ({ row }) => <span className="text-xs text-admin-text-muted font-mono">{row.original.nameEn || ''}</span>
        },
        {
            accessorKey: 'product',
            id: 'product',
        ...
        },
        {
            ...
            id: 'slug',
            header: 'اسلاگ',
            cell: ({ row }) => <span className="text-xs text-admin-text-muted font-mono">{row.original.slug || ''}</span>
        },
        {
            id: 'actions',
            header: 'عملیات',
