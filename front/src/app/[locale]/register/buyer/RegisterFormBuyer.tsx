...
type RegisterFormBuyerType = {
    isModal?: boolean
    setModal?: () => void
}
export default function RegisterFormBuyer({ isModal = false, setModal }: RegisterFormBuyerType) {
    ...
    useEffect(() => {
        ...
        if (isModal && isAuthenticated && setModal) setModal()
